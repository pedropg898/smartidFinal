                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        if (!haveNetwork()) {
                            ...
                            Toast.makeText(Presenca.this, getResources().getString(R.string.NER), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        switch (item.getItemId()) {
            ...
            case R.id.UC:
                ...
                bt.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                                ...
                                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                                    ...
                                    public void onResponse(JSONObject response) {
                                        try {
                                            ...
                                            if(ap.isEmpty()) {
                                                Toast.makeText(Presenca.this, getResources().getString(R.string.NEUC), Toast.LENGTH_SHORT).show();
                                                onResume();
                                            }
                        ...
                        MySingleton.getInstance(Presenca.this).addToRequestQueue(jsObjRequest);
            ...
            case R.id.Dia:
                ...
                et2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // TODO Auto-generated method stub
                        new DatePickerDialog(Presenca.this, date, myCalendar
                    ...
                    public void onClick(View v) {
                        ...
                        JsonObjectRequest jsObjRequest3 = new JsonObjectRequest
                                (Request.Method.GET, url3, null, new Response.Listener<JSONObject>() {
                                    ...
                                    public void onErrorResponse(VolleyError error) {
                                        if (!haveNetwork()) {
                                            Toast.makeText(Presenca.this, getResources().getString(R.string.NEPND), Toast.LENGTH_SHORT).show();
                                        }
                                        else {
                                            Toast.makeText(Presenca.this, getResources().getString(R.string.NER), Toast.LENGTH_SHORT).show();
                                        }
                        ...
                        MySingleton.getInstance(Presenca.this).addToRequestQueue(jsObjRequest3);
